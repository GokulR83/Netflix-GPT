...
const Header = () => {
  ...
  return (
    <div className='absolute w-full px-2 md:px-4 py-1 md:py-2 bg-gradient-to-b from-black z-10 flex justify-between'>
        <img 
        className='w-24 aspect-video md:w-44'
        src= {LOGO}
        alt="logo" />
        {
          user && (
              <div className='flex text-white m-4 items-center gap-6'>
                ...
                <button className='sm:text-sm border border-red-600 rounded-lg px-4 py-2 hover:bg-red-600 ease-in-out transition-all'
